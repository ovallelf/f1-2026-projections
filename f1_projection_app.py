...
def fetch_raw_season_data(year=2026, historical=None, progress_callback=None) -> dict:
    ...
    if "miami" not in result["live_fp_times"]:
        result["live_fp_times"]["miami"] = {
            "Charles Leclerc": {"fp1": 89.310},
            "Max Verstappen": {"fp1": 89.607},
            "Oscar Piastri": {"fp1": 89.758},
            "Lewis Hamilton": {"fp1": 89.777},
            "Kimi Antonelli": {"fp1": 90.079},
            "George Russell": {"fp1": 90.100},
            "Lando Norris": {"fp1": 90.208},
            "Pierre Gasly": {"fp1": 90.587},
            "Isack Hadjar": {"fp1": 90.873},
            "Carlos Sainz": {"fp1": 90.930},
            "Franco Colapinto": {"fp1": 91.015},
            "Alexander Albon": {"fp1": 91.024},
            "Oliver Bearman": {"fp1": 91.091},
            "Gabriel Bortoleto": {"fp1": 91.111},
            "Nico Hulkenberg": {"fp1": 91.595},
            "Esteban Ocon": {"fp1": 91.635},
            "Liam Lawson": {"fp1": 91.648},
            "Sergio Perez": {"fp1": 92.047},
            "Fernando Alonso": {"fp1": 92.593},
            "Valtteri Bottas": {"fp1": 92.762},
            "Arvid Lindblad": {"fp1": 92.862},
            "Lance Stroll": {"fp1": 92.959},
        }
